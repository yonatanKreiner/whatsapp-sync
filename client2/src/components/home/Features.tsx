...
const FeatureItem = ({ icon, title, description }: FeatureItemProps) => {
  return (
    <div className="flex flex-col items-start p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-whatsapp-light text-whatsapp mb-4">
        {icon}
      </div>
  ...
  const features = [
    {
      ...
      description: "Import profile pictures from WhatsApp to Google Contacts in seconds with our simple wizard."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"></path><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"></path><path d="M18 12a2 2 0 0 0-2 2c0 1.1.9 2 2 2h4v-4Z"></path>
        </svg>
      ),
      title: "Secure Authorization",
      description: "We use official OAuth protocols for both Google and WhatsApp. Your data stays private and secure."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      description: "Our algorithm intelligently matches WhatsApp contacts with your Google contacts based on phone numbers."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: "Privacy First",
      description: "We never store your contacts or images. All syncing happens directly between your accounts."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      description: "Choose which contacts to sync and preview changes before finalizing the import."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z"></path><circle cx="16.5" cy="7.5" r=".5"></circle>
        </svg>
      ),
      title: "Regular Updates",
      description: "Schedule periodic syncs to keep your contact photos fresh and up-to-date."
    }
  ];
    ...
    <section className="py-20 bg-gray-50" id="features">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything You Need for Perfect Contact Photos</h2>
          <p className="text-lg text-gray-600">
            WhatsSync simplifies the process of keeping your Google Contacts updated with the latest profile pictures from WhatsApp.
          </p>
        </div>
